...
OUTPUT_DIR = '/results/online-clustering-results/'
...
if __name__ == '__main__':
    ...
    aparser.add_argument('--output_dir', default="/results/online-clustering-results/", help='The directory that contains the time series'
                                                                   'csv files')
    ...
    with open(args['output_dir'] + "{}-{}-assignments.pickle".format(args['project'], args['rho']),
