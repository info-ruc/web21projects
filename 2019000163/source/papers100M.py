...
features,train_labels,val_labels,test_labels,train_idx,val_idx,test_idx,memory_dataset = load_transductive(args.dataset,args.agp_alg, args.alpha,args.ti,args.rmax)
