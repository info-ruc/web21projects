#!/home/liupengju/anaconda3/envs/torch/bin/python3
...
PROJECTS = {
    "tiramisu": {
        ...
        "output_dir":
        #"../results-interval-new/online-prediction/online-tiramisu-clusters-prediction",
        "../results/online-prediction/online-tiramisu-clusters-prediction",
    },
    "admission": {
        "name": "admission",
        ...
        "output_dir":
        #"../tmp/",
        #"../results-admission-full/",
        #"../results-interval/online-prediction/online-admission-clusters-prediction",
        #"../results/online-prediction/online-admission-clusters-prediction",
        "../results/online-prediction/online-admission-full-clusters-prediction",
    },
    "oli": {
        "name": "oli",
        ...
        "output_dir":
        "../results/online-prediction/online-oli-clusters-prediction",
    },
    "noise": {
        "name": "noise",
        "input_dir":
...
if __name__ == '__main__':
    ...
    aparser.add_argument('project', default="tiramisu",type=str,choices=PROJECTS.keys(), help='Data source type')
    # aparser.add_argument('--project', default="tiramisu",type=str, help='Data source type')
    ...
    # args['project']="tiramisu"
    # args['method']='rnn'
    # args['aggregate']=60
    # args['horizon']=4320
    # args['input_dir']="online-clusters/"

    # args['cluster_path']="cluster-coverage/coverage.pickle"
    # args['output_dir']="prediction-results/"
